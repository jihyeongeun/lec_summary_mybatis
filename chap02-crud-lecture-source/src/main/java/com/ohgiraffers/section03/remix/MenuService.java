 ...
 *  remix 방식의 경우는
 *  mybatis 설정은 javaconfig 방식을 취하고, 쿼리를 다루는 것은 zml방식을 취한다.
 *  DAO에 해당하는 것을 추상메소드를 지닌 인터페이스로 만드는데 이 인터페이스와 mapper용 xml은 세가지를 준수해야 한다.
...
public class MenuService {
    ...
    public static List<MenuDTO> findAllMenu() {
    ...
    public static MenuDTO findOneMenu(int menuCode) {
        SqlSession sqlSession = getSqlSession();
        MenuMapper menuMapper = sqlSession.getMapper(MenuMapper.class);
    ...
    public static boolean registMenu(MenuDTO menu) {
        SqlSession sqlSession = getSqlSession();
        MenuMapper menuMapper = sqlSession.getMapper(MenuMapper.class);
    ...
    public static boolean modifyMenu(MenuDTO menu) {
        SqlSession sqlSession = getSqlSession();
        MenuMapper menuMapper = sqlSession.getMapper(MenuMapper.class);
    ...
    public static boolean deleteMenu(MenuDTO menu) {
        SqlSession sqlSession = getSqlSession();
        MenuMapper menuMapper = sqlSession.getMapper(MenuMapper.class);
